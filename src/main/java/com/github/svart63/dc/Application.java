...
import com.github.svart63.dc.handlers.*;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        addContext(server, "/keyboard/text", new KeyboardEvenHandler());
        addContext(server, "/keyboard/backspace", new BackspaceEventHandler());
